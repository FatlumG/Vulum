...
function DashboardSidebar({classes}) {
  return (
    <div className={`bg-white py-4 w-[250px] flex flex-col items-center border-r-2 ${classes}`}>
      <SideItem
      ...
      <SideItem icon={<MdOutlineFavoriteBorder />} title="Favorite" path="/favorites" />
      <SideItem icon={<IoMailOpenOutline />} title="Inbox" path="/inbox" />
      <SideItem icon={<CiCircleList />} title="Orders List" path="/order-lists" />
      <SideItem icon={<LiaDatabaseSolid />} title="Products Stock" path="/products-stock" />
      ...
      <SideItem icon={<IoCalendarOutline />} title="Calendar" path="/calendar" />
      <SideItem icon={<RiTodoLine />} title="To Do" path="/todo" />
      <SideItem icon={<IoPeopleOutline />} title="Contact" path="/contact" />
      <SideItem icon={<LiaMoneyBillWaveSolid />} title="Invoices" path="/invoices" />
