...
let PlanRepository = class PlanRepository extends RepositoryBase_1.RepositoryBase {
    createPlan(data) {
        return __awaiter(this, void 0, void 0, function* () {
            let entity = new Plan_1.Plan();
    ...
    updatePlan(Plan, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield Plan.save(data);
        });
    }
};
PlanRepository = __decorate([
    (0, typeorm_1.EntityRepository)(Plan_1.Plan)
], PlanRepository);
