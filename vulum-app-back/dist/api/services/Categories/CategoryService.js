...
const CategoryRepository_1 = require("@api/repositories/Categories/CategoryRepository");
...
let CategoryService = class CategoryService {
    constructor(categoryRepository, eventDispatcher) {
    ...
    getAll(resourceOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.categoryRepository.getManyAndCount(resourceOptions);
        });
    }
    findOneById(id, resourceOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.getRequestedCategoryOrFail(id, resourceOptions);
        });
    }
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            let category = yield this.categoryRepository.createCategory(data);
    ...
    updateOneById(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const category = yield this.getRequestedCategoryOrFail(id);
            return yield this.categoryRepository.updateCategory(category, data);
        });
    }
    deleteOneById(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getRequestedCategoryOrFail(id, resourceOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            let category = yield this.categoryRepository.getOneById(id, resourceOptions);
            if (!category) {
